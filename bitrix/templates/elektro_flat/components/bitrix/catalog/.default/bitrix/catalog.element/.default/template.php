    ...
    if (array_key_exists(
        ...
        if (!empty($arResult["CURRENT_DISCOUNT"]["ACTIVE_TO"])) {
            if ((isset($arResult["OFFERS"]) && !empty($arResult["OFFERS"])) || ((!isset($arResult["OFFERS"]) || empty($arResult["OFFERS"])) && $arResult["CAN_BUY"])) {
                $timeBuy = "<span class='time_buy_figure'></span><span class='time_buy_text'>" . GetMessage(
                        "CATALOG_ELEMENT_TIME_BUY"
                    ) . "</span>";
            }
        }
    }
        ...
        <div class="column first<?= ($arResult["COLLECTION"]["THIS"]) ? " colletion" : "" ?>">
            <div class="catalog-detail-pictures">
                ...
                <div class="catalog-detail-picture" id="<?= $arItemIDs['PICT'] ?>">
                    ...
                    <div id="detail_picture_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                         class="detail_picture<?= ($key == $arResult['OFFERS_SELECTED'] ? '' : ' hidden'); ?>">
                        <meta content="<?= ($isOfferDetailImg ? $arOffer['DETAIL_PICTURE']['SRC'] : $isDetailImg ? $arResult['DETAIL_PICTURE']['SRC'] : SITE_TEMPLATE_PATH . '/images/no-photo.jpg'); ?>"
                              itemprop="image"/>
                        <? if ($isOfferDetailImg || $isDetailImg) { ?>
                        <a <?= ($key == $arResult['OFFERS_SELECTED'] ? 'rel="lightbox" ' : ''); ?>class="catalog-detail-images fancybox"
                           id="catalog-detail-images-<?= $arItemIDs['ID'] . '-' . $arOffer['ID'] ?>"
                           href="<?= ($isOfferDetailImg ? $arOffer['DETAIL_PICTURE']['SRC'] : $arResult['DETAIL_PICTURE']['SRC']); ?>">
                            <? } else { ?>
                            <div class="catalog-detail-images">
                                ...
                                if ($isOfferDetailImg) { ?>
                                    <img src="<?= $arOffer['DETAIL_IMG']['SRC'] ?>"
                                         ...
                                         height="<?= $arOffer['DETAIL_IMG']['HEIGHT'] ?>" alt="<?= $offerName ?>"
                                         title="<?= $offerName ?>"/>
                                <? } elseif ($isDetailImg) { ?>
                                    <img src="<?= $arResult['DETAIL_IMG']['SRC'] ?>"
                                         width="<?= $arResult['DETAIL_IMG']['WIDTH'] ?>"
                                         height="<?= $arResult['DETAIL_IMG']['HEIGHT'] ?>" alt="<?= $strAlt ?>"
                                         title="<?= $strTitle ?>"/>
                                <? } else { ?>
                                ...
                                if (is_array($arVendor["PREVIEW_PICTURE"])) { ?>
                                    <img class="manufacturer" src="<?= $arVendor['PREVIEW_PICTURE']['SRC'] ?>"
                                         width="<?= $arVendor['PREVIEW_PICTURE']['WIDTH'] ?>"
                                         height="<?= $arVendor['PREVIEW_PICTURE']['HEIGHT'] ?>"
                                         alt="<?= $arVendor['NAME'] ?>" title="<?= $arVendor['NAME'] ?>"/>
                                    <?
                                }
                                unset($arVendor); ?>
                            ...
                            <div class="detail_picture">
                                <meta content="<?= ($isDetailImg ? $arResult['DETAIL_PICTURE']['SRC'] : SITE_TEMPLATE_PATH . '/images/no-photo.jpg'); ?>"
                                      itemprop="image"/>
                                <? if ($isDetailImg) { ?>
                                <a rel="lightbox" class="catalog-detail-images fancybox"
                                   href="<?= $arResult['DETAIL_PICTURE']['SRC'] ?>">
                                    ...
                                    <? } else { ?>
                                    <div class="catalog-detail-images">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/images/no-photo.jpg" width="150"
                                             height="150" alt="<?= $strAlt ?>" title="<?= $strTitle ?>"/>
                                        <? } ?>
                                        <div class="time_buy_sticker">
                                            <?= $timeBuy ?>
                                        </div>
                                    ...
                                    <ul>
                                        <? if (!empty($arResult["PROPERTIES"]["VIDEO"]["VALUE"])) { ?>
                                            <li class="catalog-detail-video"
                                                style="<?= ($arParams['DISPLAY_MORE_PHOTO_WIDTH'] ? 'width:' . $arParams['DISPLAY_MORE_PHOTO_WIDTH'] . 'px;' : '') . ($arParams['DISPLAY_MORE_PHOTO_HEIGHT'] ? 'height:' . $arParams['DISPLAY_MORE_PHOTO_HEIGHT'] . 'px;' : ''); ?>">
                            ...
                            if (!empty($arResult["VERSIONS_PERFORMANCE"]["ITEMS"]) && count(
                                    $arResult["VERSIONS_PERFORMANCE"]["ITEMS"]
                                ) > 0) { ?>
                                <div class="clr"></div>
                                <div class="versions_performance<?= (isset($arResult["PROPERTIES"]["THIS_COLLECTION"]["VALUE"]) && !empty($arResult["PROPERTIES"]["THIS_COLLECTION"]["VALUE"])) ? ' this_collection' : ' el_collection' ?>">
                                    ...
                                    <ul>
                                        <? foreach ($arResult["VERSIONS_PERFORMANCE"]["ITEMS"] as $arColor) { ?>
                                            <? if ((is_array(
                                                        $arColor["PICTURE"]
                                                    ) && !empty($arColor["PICTURE"])) || (isset($arColor["PROPERTY_HEX_VALUE"]) && !empty($arColor["PROPERTY_HEX_VALUE"]))) { ?>
                                                <li>
                                                    <div class="image-color" style="
                                                    <? if (is_array(
                                                            $arColor["PICTURE"]
                                                        ) && !empty($arColor["PICTURE"])) { ?>
                            ...
                            <div class="price_buy_detail" itemprop="offers" itemscope
                                ...
                                <div class="catalog-detail-price" id="<?= $arItemIDs['PRICE']; ?>">
                                    ...
                                    if (isset($arResult["OFFERS"]) && !empty($arResult["OFFERS"])) {
                                        if ($arSetting["OFFERS_VIEW"]["VALUE"] != "LIST") {
                                            foreach ($arResult["OFFERS"] as $key => $arOffer) { ?>
                                                <div id="detail_price_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                     class="detail_price<?= ($key == $arResult['OFFERS_SELECTED'] ? '' : ' hidden'); ?>">
                                                    <? if ($arOffer["MIN_PRICE"]["RATIO_PRICE"] <= 0) { ?>
                                                        <span class="catalog-detail-item-no-price">
													<?= GetMessage("CATALOG_ELEMENT_NO_PRICE") ?>
                                                    <?= GetMessage(
                                                        "CATALOG_ELEMENT_UNIT"
                                                    ) . " " . (($inPriceRatio) ? $arOffer["CATALOG_MEASURE_RATIO"] : "1") . " " . $arOffer["CATALOG_MEASURE_NAME"]; ?>
												</span>
                                                    <? } else {
													...
													<span class="unit">
														...
														<?= CCurrencyLang::CurrencyFormat(
                                                            $arOffer["MIN_PRICE"]["RATIO_PRICE"] * $arSetting["REFERENCE_PRICE_COEF"]["VALUE"],
                                                    ...
                                                    <meta itemprop="price"
                                                          content="<?= $arOffer['MIN_PRICE']['RATIO_PRICE'] ?>"/>
                                                    <meta itemprop="priceCurrency"
                                                          content="<?= $arOffer['MIN_PRICE']['CURRENCY'] ?>"/>
                                                    <?//OFFERS_PRICE_RANGES//
                                                    if ($arParams["USE_PRICE_COUNT"] && count(
                                                            $arOffer["ITEM_QUANTITY_RANGES"]
                                                        ) > 1) { ?>
                                                                ...
                                                                if ($range["HASH"] !== "ZERO-INF") {
                                                                    ...
                                                                    if ($itemPrice) { ?>
                                                                        <div class="catalog-detail-price-ranges__row">
                                                                            ...
                                                                            <span class="unit">
																		<? $arCurFormat = CCurrencyLang::GetCurrencyFormat(
                                                                            $arResult['TOTAL_OFFERS']['MIN_PRICE']['CURRENCY'],
                                                                            LANGUAGE_ID
                                                                        );
                                                    ...
                                                    if (count($arOffer["PRICE_MATRIX_SHOW"]["COLS"]) > 1) { ?>
                                                        <div class="catalog-detail-price-ranges other-price">
                                                            <? foreach ($arOffer["PRICE_MATRIX_SHOW"]["COLS"] as $key_matrix => $item) {
                                                                ...
                                                                $countRange = count(
                                                                    $arOffer["PRICE_MATRIX_SHOW"]["MATRIX"][$key_matrix]
                                                                ); ?>
                                                                <div class="catalog-detail-price-ranges__row">
                                                                    <div class="catalog-detail-price-ranges__sort">
                                                                        <?= $item["NAME_LANG"] ?>
																	...
																	<a id="<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>_<?= $key_matrix ?>"
                                                                       data-key="<?= $key_matrix ?>"
                                                                       class="catalog-item-price-ranges"
                                                        ...
                                                        <? if ($arOffer["CAN_BUY"]) { ?>
                                                            <? if ($arParams['SHOW_MAX_QUANTITY'] !== 'N') { ?>
                                                                <div class="avl">
                                                                    ...
                                                                    <span>
                                                                <?= (!empty($arParams["MESS_SHOW_MAX_QUANTITY"]) ? $arParams["MESS_SHOW_MAX_QUANTITY"] : GetMessage(
                                                                    "CATALOG_ELEMENT_AVAILABLE"
                                                                )) . ' ';
                                                                if ($arParams['SHOW_MAX_QUANTITY'] === 'M') {
                                                                    if ($arOffer["CHECK_QUANTITY"] && $inProductQnt) {
                                                                        if ($arParams['RELATIVE_QUANTITY_FACTOR'] > $arOffer["CATALOG_QUANTITY"]) {
                                                                            echo GetMessage(
                                                                                "CT_BCE_CATALOG_RELATIVE_QUANTITY_FEW"
                                                                            );
                                                                        } else {
                                                                            echo GetMessage(
                                                                                "CT_BCE_CATALOG_RELATIVE_QUANTITY_MANY"
                                                                            );
                                                                        }
                                                                    }
                                                                } else {
                                            ...
                                            <div class="detail_price">
                                                ...
                                                <?= GetMessage(
                                                    "CATALOG_ELEMENT_UNIT"
                                                ) . " " . $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["CATALOG_MEASURE_RATIO"] . " " . $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["CATALOG_MEASURE_NAME"]; ?>
											</span>
                                                <? } else {
													...
													<?= GetMessage(
                                                        'CATALOG_ELEMENT_SKIDKA'
                                                    ) . " " . $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["PRINT_RATIO_DISCOUNT"]; ?>
												</span>
                                                        <?
                                                    } ?>
                                                    <span class="catalog-detail-item-price">
												<?= ($arResult["TOTAL_OFFERS"]["FROM"] == "Y" ? "<span class='from'>" . GetMessage(
                                                        "CATALOG_ELEMENT_FROM"
                                                    ) . "</span> " : "") . $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["PRINT_RATIO_PRICE"]; ?>
												<span class="unit">
													<?= GetMessage(
                                                        "CATALOG_ELEMENT_UNIT"
                                                    ) . " " . (($inPriceRatio) ? $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["CATALOG_MEASURE_RATIO"] : "1") . " " . $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["CATALOG_MEASURE_NAME"]; ?>
												</span>
											</span>
                                                    <? if ($arSetting["REFERENCE_PRICE"]["VALUE"] == "Y" && !empty($arSetting["REFERENCE_PRICE_COEF"]["VALUE"])) { ?>
                                                        <span class="catalog-detail-item-price-reference">
													<?= CCurrencyLang::CurrencyFormat(
                                                        $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["RATIO_PRICE"] * $arSetting["REFERENCE_PRICE_COEF"]["VALUE"],
                                                        $arResult["TOTAL_OFFERS"]["MIN_PRICE"]["CURRENCY"],
                                                        true
                                                    ); ?>
												</span>
                                                ...
                                                <meta itemprop="price"
                                                      content="<?= $arResult['TOTAL_OFFERS']['MIN_PRICE']['RATIO_PRICE'] ?>"/>
                                                <meta itemprop="priceCurrency"
                                        ...
                                        if (array_key_exists(
                                            ...
                                            if (!empty($arResult["CURRENT_DISCOUNT"]["ACTIVE_TO"])) {
                                                ...
                                                <div class="progress_bar_block">
                                                    <span class="progress_bar_title"><?= GetMessage(
                                                            "CATALOG_ELEMENT_QUANTITY_PERCENT"
                                                        ) ?></span>
                                        ...
                                        <?= GetMessage(
                                            "CATALOG_ELEMENT_UNIT"
                                        ) . " " . (($inPriceRatio) ? $arResult["CATALOG_MEASURE_RATIO"] : "1") . " " . $arResult["CATALOG_MEASURE_NAME"]; ?>
									</span>
                                        <? } else {
											...
											<?= GetMessage(
                                                'CATALOG_ELEMENT_SKIDKA'
                                            ) . " " . $arResult["MIN_PRICE"]["PRINT_RATIO_DISCOUNT"]; ?>
										</span>
                                            <? } ?>
                                            <span class="catalog-detail-item-price">
										<span class="catalog-detail-item-price-current">
										...
										<span class="unit">
                                            ...
                                            <? if ($arSetting["REFERENCE_PRICE"]["VALUE"] == "Y" && !empty($arSetting["REFERENCE_PRICE_COEF"]["VALUE"])) { ?>
                                                <span class="catalog-detail-item-price-reference">
											<?= CCurrencyLang::CurrencyFormat(
                                                $arResult["MIN_PRICE"]["RATIO_PRICE"] * $arSetting["REFERENCE_PRICE_COEF"]["VALUE"],
                                        ...
                                        <? if (count($arResult["PRICE_MATRIX_SHOW"]["COLS"]) > 1) { ?>
                                            <div class="catalog-detail-price-ranges other-price">
                                                <? foreach ($arResult["PRICE_MATRIX_SHOW"]["COLS"] as $key => $item) {
                                                    ...
                                                    $countRange = count(
                                                        $arResult["PRICE_MATRIX_SHOW"]["MATRIX"][$key]
                                                    ); ?>
                                                    <div class="catalog-detail-price-ranges__row">
                                                        <div class="catalog-detail-price-ranges__sort">
                                                            <?= $item["NAME_LANG"] ?>
                                                        ...
                                                        <? if ($countRange > 1): ?>
                                                            <span class="catalog-item-price-ranges-wrap">
														<a id="<?= $arItemIDs['PRICE_MATRIX_BTN'] ?>_<?= $key ?>"
                                                           data-key="<?= $key ?>" class="catalog-item-price-ranges"
                                                           href="javascript:void(0);">
															<i class="fa fa-question-circle-o"></i>
														</a>
													</span>
                                ...
                                <div class="catalog-detail-buy" id="<?= $arItemIDs['BUY']; ?>">
                                    ...
                                    if (!empty($arResult["CURRENT_DISCOUNT"]["ACTIVE_TO"])) {
                                        $new_date = ParseDateTime(
                                            $arResult["CURRENT_DISCOUNT"]["ACTIVE_TO"],
                                            FORMAT_DATETIME
                                        ); ?>
                                        <script type="text/javascript">
                                            $(function () {
                                                $("#time_buy_timer_<?=$arItemIDs['ID']?>").countdown({
                                                    ...
                                                    format: "DHMS",
                                                    expiryText: "<div class='over'><?=GetMessage(
                                                        'CATALOG_ELEMENT_TIME_BUY_EXPIRY'
                                                    )?></div>"
                                                });
                                            });
                                        </script>
                                        <div class="time_buy_cont">
                                            ...
                                            <div class="time_buy_timer"
                                                 id="time_buy_timer_<?= $arItemIDs['ID'] ?>"></div>
                                        </div>
                                    <?
                                    }
                                    }
                                    ...
                                    if ($arSetting["OFFERS_VIEW"]["VALUE"] != "LIST") {
                                    foreach ($arResult["OFFERS"] as $key => $arOffer) { ?>
                                        <div id="buy_more_detail_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                             class="buy_more_detail<?= ($key == $arResult['OFFERS_SELECTED'] ? '' : ' hidden'); ?>">
                                            <? $offerName = isset($arOffer["NAME"]) && !empty($arOffer["NAME"]) ? $arOffer["NAME"] : $arResult["NAME"];
                                            $properties = array();
                                            foreach ($arOffer["DISPLAY_PROPERTIES"] as $propOffer) {
                                                if ($propOffer["PROPERTY_TYPE"] != "S") {
                                                    $properties[] = $propOffer["NAME"] . ": " . strip_tags(
                                                            $propOffer["DISPLAY_VALUE"]
                                                        );
                                                }
                                            }
                                            ...
                                            if ($arOffer["CAN_BUY"]) {
                                                if ($arOffer["MIN_PRICE"]["RATIO_PRICE"] <= 0) {
                                                    ...
                                                    <form action="javascript:void(0)">
                                                        ...
                                                        <button type="button"
                                                                id="<?= $arItemIDs['POPUP_BTN'] . '_' . $arOffer['ID'] ?>"
                                                                class="btn_buy apuo_detail"><i
                                                                    class="fa fa-comment-o"></i><span><?= GetMessage(
                                                                    "CATALOG_ELEMENT_ASK_PRICE"
                                                                ) ?></span></button>
                                                    </form>
                                                <? } else { ?>
                                                    <div class="add2basket_block">
                                                        <form action="<?= SITE_DIR ?>ajax/add2basket.php"
                                                            ...
                                                            <div class="qnt_cont">
                                                                ...
                                                                <input type="text"
                                                                       id="quantity_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                                       name="quantity" class="quantity"
                                                                       value="<?= (!empty($arOffer['MIN_PRICE']['QUANTITY_FROM']) ? $arOffer['MIN_PRICE']['QUANTITY_FROM'] : $arOffer['MIN_PRICE']['MIN_QUANTITY']) ?>"/>
                                                            ...
                                                            $props = !empty($props) ? strtr(
                                                                base64_encode(serialize($props)),
                                                                "+/=",
                                                                "-_,"
                                                            ) : ""; ?>
                                                            <input type="hidden" name="PROPS"
                                                                   id="props_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                                   value="<?= $props ?>"/>
                                                            <? if (!empty($arResult["SELECT_PROPS"])) { ?>
                                                                <input type="hidden" name="SELECT_PROPS"
                                                                       id="select_props_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                                       value=""/>
                                                                <?
                                                            } ?>
                                                            <button type="button" class="btn_buy detail"
                                                                    name="add2basket"><i
                                                                        class="fa fa-shopping-cart"></i><span><?= ($arSetting["NAME_BUTTON_TO_CART"]["VALUE"] ? $arSetting["NAME_BUTTON_TO_CART"]["VALUE"] : GetMessage(
                                                                        "CATALOG_ELEMENT_ADD_TO_CART"
                                                                    )) ?></span></button>
                                                        </form>
                                                        <?//OFFERS_BUY_ONE_CLICK//
                                                        if ($inBtnBoc) { ?>
                                                            <button id="<?= $arItemIDs['POPUP_BTN'] ?>"
                                                                    class="btn_buy boc_anch" data-action="boc"><i
                                                                        class="fa fa-bolt"></i><span><?= GetMessage(
                                                                        'CATALOG_ELEMENT_BOC'
                                                                    ) ?></span></button>
                                                            <?
                                                        }
                                                        ...
                                                        if ($inBtnCheaper) { ?>
                                                            <form action="javascript:void(0)" class="cheaper_form">
                                                                ...
                                                                <input type="hidden" name="PRICE"
                                                                       value="<?= $arOffer['MIN_PRICE']['PRINT_RATIO_PRICE'] ?>"/>
                                                                <button type="button"
                                                                        id="<?= $arItemIDs['POPUP_BTN'] ?>"
                                                                        class="btn_buy apuo cheaper_anch"><i
                                                                            class="fa fa-commenting-o"></i><span><?= GetMessage(
                                                                            'CATALOG_ELEMENT_CHEAPER'
                                                                        ) ?></span></button>
                                                            </form>
                                                            <?
                                                        } ?>
                                                ...
                                                <form action="javascript:void(0)" class="apuo_form">
                                                    ...
                                                    <input type="hidden" name="NAME" value="<?= $elementName ?>"/>
                                                    <button type="button" id="<?= $arItemIDs['POPUP_BTN'] ?>"
                                                            class="btn_buy apuo_detail"><i
                                                                class="fa fa-clock-o"></i><span
                                                                class="short"><?= GetMessage(
                                                                "CATALOG_ELEMENT_UNDER_ORDER"
                                                            ) ?></span></button>
                                                </form>
                                            <? } ?>
                                        </div>
                                    <? } ?>
                                        <div id="<?= $arItemIDs['BTN_BUY'] ?>"
                                             class="hidden_btn_offer_prediction"></div>
                                        ...
                                        <div class="buy_more_detail">
                                            ...
                                            <button class="btn_buy detail" name="choose_offer"><?= GetMessage(
                                                    'CATALOG_ELEMENT_CHOOSE_OFFER'
                                                ) ?></button>
                                        </div>
                                    <?
                                    }
                                    ...
                                    //DETAIL_BUY//?>
                                        <div class="buy_more_detail">
                                            <? if ($arResult["CAN_BUY"]) {
                                                if ($arResult["MIN_PRICE"]["RATIO_PRICE"] <= 0) {
                                                    //DETAIL_ASK_PRICE//?>
                                                    <a id="<?= $arItemIDs['POPUP_BTN'] ?>" class="btn_buy apuo_detail"
                                                       href="javascript:void(0)" rel="nofollow" data-action="ask_price"><i
                                                                class="fa fa-comment-o"></i><span><?= GetMessage(
                                                                "CATALOG_ELEMENT_ASK_PRICE"
                                                            ) ?></span></a>
                                                <? } else { ?>
                                                    <form action="<?= SITE_DIR ?>ajax/add2basket.php"
                                                        ...
                                                        <? if (!$arResult["COLLECTION"]["THIS"]) { ?>
                                                            <div class="qnt_cont">
                                                                <a href="javascript:void(0)" class="minus"
                                                                   id="quantity_minus_<?= $arItemIDs['ID'] ?>"><span>-</span></a>
                                                                <input type="text" id="quantity_<?= $arItemIDs['ID'] ?>"
                                                                       name="quantity" class="quantity"
                                                                       value="<?= (!empty($arResult['MIN_PRICE']["QUANTITY_FROM"]) ? $arResult['MIN_PRICE']["QUANTITY_FROM"] : $arResult['MIN_PRICE']['MIN_QUANTITY']) ?>"/>
                                                                <a href="javascript:void(0)" class="plus"
                                                                   id="quantity_plus_<?= $arItemIDs['ID'] ?>"><span>+</span></a>
                                                            </div>
                                                            <?
                                                        } ?>
                                                        ...
                                                        if (!empty($arResult["PROPERTIES"]["ARTNUMBER"]["VALUE"])) {
                                                            ...
                                                            <input type="hidden" name="PROPS"
                                                                   id="props_<?= $arItemIDs['ID'] ?>"
                                                                   value="<?= $props ?>"/>
                                                            <?
                                                        }
                                                        if (!empty($arResult["SELECT_PROPS"])) { ?>
                                                            <input type="hidden" name="SELECT_PROPS"
                                                                   id="select_props_<?= $arItemIDs['ID'] ?>" value=""/>
                                                            <?
                                                        } ?>
                                                        <? if (!$arResult["COLLECTION"]["THIS"]) { ?>
                                                            <button type="button" id="<?= $arItemIDs['BTN_BUY'] ?>"
                                                                    class="btn_buy detail" name="add2basket"><i
                                                                        class="fa fa-shopping-cart"></i><span><?= ($arSetting["NAME_BUTTON_TO_CART"]["VALUE"] ? $arSetting["NAME_BUTTON_TO_CART"]["VALUE"] : GetMessage(
                                                                        "CATALOG_ELEMENT_ADD_TO_CART"
                                                                    )) ?></span></button>
                                                        <? } else { ?>
                                                            <button onclick="toItem(this)" type="button" id="to_item"
                                                                    class="btn_buy toitem" name="toitem">
                                                                <span><?= GetMessage(
                                                                        'CATALOG_ELEMENT_TO_ITEM'
                                                                    ) ?></span></button>
                                                            <script type="text/javascript">
                                                ...
                                                <a id="<?= $arItemIDs['POPUP_BTN'] ?>" class="btn_buy apuo_detail"
                                                   href="javascript:void(0)" rel="nofollow" data-action="under_order"><i
                                                            class="fa fa-clock-o"></i><span><?= GetMessage(
                                                            "CATALOG_ELEMENT_UNDER_ORDER"
                                                        ) ?></span></a>
                                            <? } ?>
                                        </div>
                                ...
                                <? //COMPARE_DELAY//?>
                                <? if (!$arResult["COLLECTION"]["THIS"]) { ?>
                                    <div class="compare_delay" style="display: none">
                                        <? //DETAIL_COMPARE//
                                        if ($arParams["DISPLAY_COMPARE"] == "Y") { ?>
                                            <div class="compare">
                                                <a href="javascript:void(0)" class="catalog-item-compare"
                                                   id="catalog_add2compare_link_<?= $arItemIDs['ID'] ?>"
                                                   onclick="return addToCompare('<?= $arResult["COMPARE_URL"] ?>', 'catalog_add2compare_link_<?= $arItemIDs["ID"] ?>', '<?= SITE_DIR ?>');"
                                                   rel="nofollow"><span class="compare_cont"><i
                                                                class="fa fa-bar-chart"></i><i
                                                                class="fa fa-check"></i><span
                                                                class="compare_text"><?= GetMessage(
                                                                'CATALOG_ELEMENT_ADD_TO_COMPARE'
                                                            ) ?></span></span></a>
                                            </div>
                                        <? } ?>
                                        <div class="catalog-detail-delay" id="<?= $arItemIDs['DELAY'] ?>">
                                            ...
                                            if (isset($arResult["OFFERS"]) && !empty($arResult["OFFERS"])) {
                                                if ($arSetting["OFFERS_VIEW"]["VALUE"] != "LIST") {
                                                    foreach ($arResult["OFFERS"] as $key => $arOffer) {
                                                        if ($arOffer["CAN_BUY"] && $arOffer["MIN_PRICE"]["RATIO_PRICE"] > 0) {
                                                            ...
                                                            <div id="delay_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                                 class="delay<?= ($key == $arResult['OFFERS_SELECTED'] ? '' : ' hidden'); ?>">
                                                                <a href="javascript:void(0)"
                                                                   id="catalog-item-delay-<?= $arItemIDs['ID'] . '-' . $arOffer['ID'] ?>"
                                                                   class="catalog-item-delay"
                                                                   onclick="return addToDelay('<?= $arOffer["ID"] ?>', 'quantity_<?= $arItemIDs['ID'] . '_' . $arOffer["ID"] ?>', '<?= $props ?>', '', 'catalog-item-delay-<?= $arItemIDs['ID'] . '-' . $arOffer["ID"] ?>', '<?= SITE_DIR ?>')"
                                                                   rel="nofollow"><span class="delay_cont"><i
                                                                                class="fa fa-heart-o"></i><i
                                                                                class="fa fa-check"></i><span
                                                                                class="delay_text"><?= GetMessage(
                                                                                'CATALOG_ELEMENT_ADD_TO_DELAY'
                                                                            ) ?></span></span></a>
                                                            </div>
                                                            <?
                                                        }
                                                ...
                                                if ($arResult["CAN_BUY"] && $arResult["MIN_PRICE"]["RATIO_PRICE"] > 0) {
                                                    ...
                                                    <div class="delay">
                                                        <a href="javascript:void(0)"
                                                           id="catalog-item-delay-<?= $arItemIDs['ID'] ?>"
                                                           class="catalog-item-delay"
                                                           onclick="return addToDelay('<?= $arResult["ID"] ?>', 'quantity_<?= $arItemIDs["ID"] ?>', '<?= $props ?>', '', 'catalog-item-delay-<?= $arItemIDs["ID"] ?>', '<?= SITE_DIR ?>')"
                                                           rel="nofollow"><span class="delay_cont"><i
                                                                        class="fa fa-heart-o"></i><i
                                                                        class="fa fa-check"></i><span
                                                                        class="delay_text"><?= GetMessage(
                                    ...
                                    <div class="catalog-detail-buttons">
                                        <? if ($inBtnPayments) { ?>
                                            <a rel="nofollow" target="_blank"
                                               href="<?= !empty($arParams['BUTTON_PAYMENTS_HREF']) ? $arParams['BUTTON_PAYMENTS_HREF'] : 'javascript:void(0)' ?>"
                                               class="btn_buy apuo pcd"><i
                                                        class="fa fa-credit-card"></i><span><?= GetMessage(
                                                        'CATALOG_ELEMENT_BUTTON_PAYMENTS'
                                                    ) ?></span></a>
                                            <?
                                        }
                                        if ($inBtnCredit) { ?>
                                            <a rel="nofollow" target="_blank"
                                               href="<?= !empty($arParams['BUTTON_CREDIT_HREF']) ? $arParams['BUTTON_CREDIT_HREF'] : 'javascript:void(0)' ?>"
                                               class="btn_buy apuo pcd"><i
                                                        class="fa fa-percent"></i><span><?= GetMessage(
                                                        'CATALOG_ELEMENT_BUTTON_CREDIT'
                                                    ) ?></span></a>
                                            <?
                                        } ?>
                                    </div>
                                ...
                                //DETAIL_GEOLOCATION_DELIVERY//?>
                                <div id="<?= $arItemIDs['DELIVERY'] ?>" style="display: none">
                                    <? if ($arParams["AJAX_MODE"] == "Y") { ?>
                                            ...
                                            if (isset($arResult["JS_OFFERS"]) && !empty($arResult["JS_OFFERS"])):
                                                if ($arSetting["OFFERS_VIEW"]["VALUE"] != "LIST"):
                                                    ...
                                                    if ($arOffer["CAN_BUY"] && $arOffer["ITEM_PRICES"][$arOffer["ITEM_PRICE_SELECTED"]]["RATIO_PRICE"] > 0):?>
                                                        <div id="geolocation-delivery-from"
                                                             class="geolocation-delivery-from">
                                                            <? $APPLICATION->IncludeComponent(
                                                                "altop:geolocation.delivery", "",
                                                                array(
                                ...
                                if ($inBtnDelivery) { ?>
                                    <div class="catalog-detail-buttons">
                                        <a rel="nofollow" target="_blank"
                                           href="<?= !empty($arParams['BUTTON_DELIVERY_HREF']) ? $arParams['BUTTON_DELIVERY_HREF'] : 'javascript:void(0)' ?>"
                                           class="btn_buy apuo pcd"><i class="fa fa-truck"></i><span><?= GetMessage(
                                                    'CATALOG_ELEMENT_BUTTON_DELIVERY'
                                                ) ?></span></a>
                                    </div>
                                <? } ?>
                            </div>
                                            ...
                                            <div class="catalog-detail-offers"
                                                ...
                                                <? foreach ($arResult["SELECT_PROPS"] as $key => &$arProp) {
                                                    ...
                                                    <div class="offer_block"
                                                        ...
                                                        <div class="h3"><?= htmlspecialcharsex(
                                                                $arProp["NAME"]
                                                            ); ?></div>
                            ...
                            if (!empty($arResult["DISPLAY_MAIN_PROPERTIES"]) || $strMainOffersProps) { ?>
                                <div class="catalog-detail-properties">
                                                ...
                                                <? if (!empty($v["FILTER_HINT"])) { ?>
                                                    <div class="hint-wrap">
                                                        <a class="hint" href="javascript:void(0);"
                                                           onclick="showDetailPropertyFilterHint(this, '<?= $v['FILTER_HINT'] ?>');"><i
                                                                    class="fa fa-question-circle-o"></i></a>
                                                    </div>
                                                    <?
                                                } ?>
                                                <div class="dots"></div>
                                                <div class="val"><?= is_array($v["DISPLAY_VALUE"]) ? implode(
                                                        ", ",
                                                        $v["DISPLAY_VALUE"]
                                                    ) : $v["DISPLAY_VALUE"]; ?></div>
                                            </div>
                                    ...
                                    if ($strMainOffersProps) {
                                        foreach ($arResult["OFFERS"] as $key => $arOffer) { ?>
                                            <div id="offer-property_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                 class="offer-property<?= ($key == $arResult['OFFERS_SELECTED'] ? '' : ' hidden'); ?>">
                                                <? if (!empty($arOffer["DISPLAY_MAIN_PROPERTIES"])) {
            ...
            <div id="catalog-detail-offers-list" class="catalog-detail-offers-list">
                ...
                <div class="offers-items">
                    ...
                    <div class="tbody">
                        ...
                        $offerName = isset($arOffer["NAME"]) && !empty($arOffer["NAME"]) ? $arOffer["NAME"] : $arResult["NAME"]; ?>
                        <div class="catalog-item" id="catalog-offer-item-<?= $arItemIDs['ID'] . '-' . $arOffer['ID'] ?>"
                             data-offer-num="<?= $keyOffer ?>" data-link="<?= $arOffer['ID'] ?>">
                            <div class="catalog-item-info">
                                <? //OFFERS_LIST_IMAGE//?>
                                <div class="catalog-item-image-cont">
                                    <div class="catalog-item-image">
                                        <? if ($isOfferPreviewImg || $isPreviewImg) { ?>
                                        <a rel="lightbox" class="fancybox"
                                           href="<?= ($isOfferPreviewImg ? $arOffer['DETAIL_PICTURE']['SRC'] : $arResult['DETAIL_PICTURE']['SRC']); ?>">
                                            <? } else { ?>
                                            <div>
                                                <?
                                                }
                                                ...
                                                <? } elseif ($isPreviewImg) { ?>
                                                    <img src="<?= $arResult['PREVIEW_IMG']['SRC'] ?>"
                                                         ...
                                                         alt="<?= $strAlt ?>" title="<?= $strTitle ?>"/>
                                                <? } else { ?>
                                                    <img src="<?= SITE_TEMPLATE_PATH ?>/images/no-photo.jpg" width="72"
                                                         height="72" alt="<?= $strAlt ?>" title="<?= $strTitle ?>"/>
                                                    <?
                                                } ?>
                                                <div class="sticker">
                                                    <?= $sticker ?>
                                    ...
                                    <div class="catalog-item-title">
                                        ...
                                        <span class="article"><?= GetMessage(
                                                "CATALOG_ELEMENT_ARTNUMBER"
                                            ) ?><?= !empty($arOffer["PROPERTIES"]["ARTNUMBER"]["VALUE"]) ? $arOffer["PROPERTIES"]["ARTNUMBER"]["VALUE"] : "-"; ?></span>
                                    </div>
                                    <? //OFFERS_LIST_PROPS//
                                    $i = 1;
                                    foreach ($arResult["SKU_PROPS"] as $arProp) {
                                    ...
                                    <div class="item-price">
                                        ...
                                        if ($arCurFormat["HIDE_ZERO"] == "Y") {
                                            ...
                                            if (round(
                                                    $arOffer["MIN_PRICE"]["RATIO_PRICE"],
                                                    $arCurFormat["DECIMALS"]
                                                ) == round($arOffer["MIN_PRICE"]["RATIO_PRICE"], 0)) {
                                        ...
                                        if ($arOffer["MIN_PRICE"]["RATIO_PRICE"] <= 0) { ?>
											...
											<span class="unit">
												...
												<span><?= GetMessage(
                                                        "CATALOG_ELEMENT_UNIT"
                                                    ) . " " . (($inPriceRatio) ? $arOffer["CATALOG_MEASURE_RATIO"] : "1") . " " . $arOffer["CATALOG_MEASURE_NAME"]; ?></span>
											</span>
										</span>
                                        <? } else { ?>
                                            ...
                                            if ($arParams["USE_PRICE_COUNT"] && count(
                                                ...
                                                <span class="catalog-item-price-ranges-wrap">
													<a class="catalog-item-price-ranges" href="javascript:void(0);"><i
                                                                class="fa fa-question-circle-o"></i></a>
												</span>
                                                <?
                                            } ?>
                                                <? if (count($arOffer["PRICE_MATRIX_SHOW"]["COLS"]) > 1 && count(
                                                        $arOffer["ITEM_QUANTITY_RANGES"]
                                                    ) <= 1) { ?>
                                                    <span class="catalog-item-price-ranges-wrap">
													<a class="catalog-item-price-ranges" href="javascript:void(0);"><i
											...
											<? if ($arSetting["REFERENCE_PRICE"]["VALUE"] == "Y" && !empty($arSetting["REFERENCE_PRICE_COEF"]["VALUE"])) { ?>
                                                <span class="catalog-item-price-reference">
													<?= number_format(
                                                        $arOffer["MIN_PRICE"]["RATIO_PRICE"] * $arSetting["REFERENCE_PRICE_COEF"]["VALUE"],
                                                        $arCurFormat["REFERENCE_DECIMALS"],
                                                        $arCurFormat["DEC_POINT"],
                                                        $arCurFormat["THOUSANDS_SEP"]
                                                    ); ?>
													<span><?= $currency ?></span>
                                    ...
                                    if (!empty($arOffer["DISPLAY_PROPERTIES"])) { ?>
                                        <div id="catalog-item-props-mob-<?= $arItemIDs['ID'] . '-' . $arOffer['ID'] ?>"
                                             class="catalog-item-props-mob"></div>
                                        <?
                                    }
                                        ...
                                        if ($arOffer["CAN_BUY"]) {
                                            if ($arOffer["MIN_PRICE"]["RATIO_PRICE"] <= 0) {
                                                ...
                                                <form action="javascript:void(0)" class="apuo_form">
                                                    ...
                                                    <input type="hidden" name="NAME" value="<?= $elementName ?>"/>
                                                    <button type="button" id="<?= $arItemIDs['POPUP_BTN'] ?>"
                                                            class="btn_buy apuo"><i class="fa fa-comment-o"></i><span
                                                                class="short"><?= GetMessage(
                                                                "CATALOG_ELEMENT_ASK_PRICE_SHORT"
                                                            ) ?></span></button>
                                                </form>
                                            <? } else {
                                                $props = array();
                                                    ...
                                                    <form action="<?= SITE_DIR ?>ajax/add2basket.php"
                                                        ...
                                                        <div class="qnt_cont">
                                                            ...
                                                            <input type="text"
                                                                   id="quantity_<?= $arItemIDs['ID'] . '_' . $arOffer['ID'] ?>"
                                                                   name="quantity" class="quantity"
                                                                   value="<?= $arOffer['MIN_PRICE']['MIN_QUANTITY'] ?>"/>
                                                            <a href="javascript:void(0)" class="plus"><span>+</span></a>
                                                        </div>
                                                        <input type="hidden" name="ID" class="offer_id"
                                                               value="<?= $arOffer['ID'] ?>"/>
                                                        ...
                                                        <button type="button" class="btn_buy" name="add2basket"><i
                                            ...
                                            <form action="javascript:void(0)" class="apuo_form">
                                                ...
                                                <input type="hidden" name="NAME" value="<?= $elementName ?>"/>
                                                <button type="button" id="<?= $arItemIDs['POPUP_BTN'] ?>"
                                                        class="btn_buy apuo"><i class="fa fa-clock-o"></i><span
                                                            class="short"><?= GetMessage(
                                                            "CATALOG_ELEMENT_UNDER_ORDER_SHORT"
                                                        ) ?></span></button>
                                            </form>
                                            <?
                                        } ?>
                ...
                if ($arResult["CATALOG"] && $arParams["USE_GIFTS_DETAIL"] == "Y" && \Bitrix\Main\ModuleManager::isModuleInstalled(
                        "sale"
                    )) { ?>
                                ...
                                <div class="catalog-item-card">
                                    <div class="catalog-item-info">
                                                ...
                                                <? } else { ?>
                                                    <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>">
                                                        <img class="item_img"
                                                             ...
                                                             width="150" height="150" alt="<?= $arItem['NAME'] ?>"
                                                             title="<?= $arItem['NAME'] ?>"/>
                                                    </a>
                                                    <?
                                                } ?>
                                        ...
                                        <div class="item-price-cont<?= (!$inOldPrice ? ' one' : '') . ($arSetting["REFERENCE_PRICE"]["VALUE"] == "Y" && !empty($arSetting["REFERENCE_PRICE_COEF"]["VALUE"]) ? ' reference' : ''); ?>">
                                            <? $price = CCurrencyLang::GetCurrencyFormat(
                                            ...
                                            if ($price["HIDE_ZERO"] == "Y") {
                                                if (round($arItem["PRICE_DISCOUNT_VALUE"], $price["DECIMALS"]) == round(
                                                        $arItem["PRICE_DISCOUNT_VALUE"],
                                                        0
                                                    )) {
                                                    $price["DECIMALS"] = 0;
                                                }
                                            ...
                                            <div class="item-price">
                                                <? if ($inOldPrice) {
                                                    if ($arItem["PRICE_DISCOUNT_VALUE"] < $arItem["PRICE_VALUE"]) { ?>
                                                        <span class="catalog-item-price-old">
												<?= CCurrencyLang::CurrencyFormat(
                                                    $arItem["PRICE_VALUE"] * $arItem["BASKET_QUANTITY"],
                                                    $arItem["PRICE_CURRENCY"],
                                                    true
                                                ); ?>
											</span>
                                                ...
                                                <span class="catalog-item-price">
										<?= number_format(
                                            $arItem["PRICE_DISCOUNT_VALUE"] * $arItem["BASKET_QUANTITY"],
                                            $price["DECIMALS"],
                                            $price["DEC_POINT"],
                                            $price["THOUSANDS_SEP"]
                                        ); ?>
										<span class="unit">
											...
											<span><?= GetMessage(
                                                    "CATALOG_ELEMENT_UNIT"
                                                ) . " " . ($arItem["BASKET_QUANTITY"] > 0 && $arItem["BASKET_QUANTITY"] != 1 ? $arItem["BASKET_QUANTITY"] . " " : "") . $arItem["MEASURE"]["SYMBOL_RUS"]; ?></span>
										</span>
									</span>
                                                <? if ($arSetting["REFERENCE_PRICE"]["VALUE"] == "Y" && !empty($arSetting["REFERENCE_PRICE_COEF"]["VALUE"])) { ?>
                                                    <span class="catalog-item-price-reference">
											<?= CCurrencyLang::CurrencyFormat(
                                                $arItem["PRICE_DISCOUNT_VALUE"] * $arItem["BASKET_QUANTITY"] * $arSetting["REFERENCE_PRICE_COEF"]["VALUE"],
                                                $arItem["PRICE_CURRENCY"],
                                                true
                                            ); ?>
										</span>
                    ...
                    <ul class="tabs">
                        ...
                        <? if ($arResult["COLLECTION"]["THIS"]) { ?>
                            <li class="tabs__tab current" onclick="setBox(this)">
                                <a href="<?= ($arParams["AJAX_OPTION_HISTORY"] !== "Y") ? "#tab" . $i : "javascript:void(0)" ?>"><span><?= GetMessage(
                                            "CATALOG_ELEMENT_COLLECTION"
                                        ) ?></span></a>
                            </li>
                            <? $i++;
                        } ?>
                        <li class="tabs__tab<?= (!$arResult["COLLECTION"]["THIS"]) ? " current" : "" ?>">
                            <a href="<?= ($arParams["AJAX_OPTION_HISTORY"] !== "Y") ? "#tab" . $i : "javascript:void(0)" ?>"><span><?= GetMessage(
                                        "CATALOG_ELEMENT_FULL_DESCRIPTION"
                                    ) ?></span></a>
                        </li>
                        <? $i++;
                        $strMainOffersProps = false;
                        ...
                        <li class="tabs__tab">
                            <a <?= ($arParams["AJAX_MODE"] == "Y") ? "id='reviews_count'" : "" ?>
                                    href="<?= ($arParams["AJAX_OPTION_HISTORY"] !== "Y") ? "#tab" . $i : "javascript:void(0)" ?>"><span><?= GetMessage(
                                        "CATALOG_ELEMENT_REVIEWS"
                                    ) ?> <span
                                            class="reviews_count"><?= ($arParams["AJAX_OPTION_HISTORY"] == "Y" && $arParams["AJAX_MODE"] == "Y") ? "(" . $arResult["REVIEWS"]["COUNT"] . ")" : "" ?></span></span></a>
                        </li>
                        <? $i++;
                        ...
                        <div class="tabs__box" id="collection-to" style="display:block">
                            <? if ($arParams["AJAX_OPTION_HISTORY"] == "Y" && $arParams["AJAX_MODE"] == "Y") { ?>
                                <div id="collection-from" class="collection">
                                    ...
                                    <? $content = $APPLICATION->IncludeComponent("bitrix:catalog.section",
                                                                                 "items_collection",
                                                                                 array(
                                                                                     "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
                                                                                     "IBLOCK_ID" => $arParams["IBLOCK_ID"],
                                ...
                                <div class="files-docs-item-cont">
                                    <a class="files-docs-item" href="<?= $arDoc['SRC'] ?>" target="_blank">
                                        ...
                                        <div class="files-docs-block">
                                            ...
                                            <span class="files-docs-size"><?= GetMessage(
                                                    "CATALOG_ELEMENT_SIZE"
                                                ) . $arDoc["SIZE"] ?></span>
                                        </div>
                                    </a>
                                </div><!--
                                        ...
                                        if (isset($arResult["JS_OFFERS"]) && !empty($arResult["JS_OFFERS"])):
                                            if ($arSetting["OFFERS_VIEW"]["VALUE"] != "LIST"):
                                                ...
                                                <div id="catalog-detail-stores-from" class="catalog-detail-stores-from">
                                                    <? $APPLICATION->IncludeComponent("bitrix:catalog.store.amount",
                                                                                      ".default",
                                                                                      array(
                                                                                          "ELEMENT_ID" => $arOffer["ID"],
            ...
            <? if (isset($arResult["OFFERS"]) && !empty($arResult["OFFERS"])) {
                $arJSParams = array(
                    ...
                    "VISUAL" => array(
                        ...
                        "PRICE_MATRIX_BTN_ID" => is_array(
                            $arResult["ID_PRICE_MATRIX_BTN"]
                        ) ? $arResult["ID_PRICE_MATRIX_BTN"] : "",
                        "ADD2BASKET_WINDOW" => in_array(
                            "ADD2BASKET_WINDOW",
